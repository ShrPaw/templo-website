...
### Business Hours
- **Monday to Friday:** 6:00 a.m. – 12:00 p.m. / 2:00 p.m. – 9:00 p.m.
- **Saturday:** 6:00 a.m. – 2:00 p.m.
- **Sunday:** Not provided / not listed as open
- **Session availability:** Confirm by WhatsApp

### Contact
- **WhatsApp:** +591 72001680 (verified)
- **Instagram:** @templo.bol (link exists, activity not verified)
- **Facebook:** templo.bol (link exists, activity not verified)

### Location
- **City:** Cochabamba, Bolivia (verified)
- **Exact address:** "Ciclovía casi Av. Simón López" (approximate, needs verification)
- **Google Maps:** Uses approximate city-level coordinates — **needs exact embed URL**

### Pricing
- **Range:** Bs. 230 – Bs. 550 (verified from plan cards)
- **Plans:** Power Plate, Calistenia, Híbrido, Open Gym, Seniors, Mujeres (verified)
...
- Warm tones (gold/amber accents)
- Show real equipment, real space, real atmosphere
- Avoid: bright/clinical, cluttered, Instagram filter heavy
- Minimum resolution: 800px on shortest side
- Format: WebP preferred, JPEG acceptable

### 2. Real Testimonials / Proof
...
|------|---------|----------|
| **FAQ inputs** | Expand FAQ with real questions from clients | Medium |
| **Cancellation policy** | Reduce friction, set expectations | Low |
| **Parking info** | Reduce friction for visitors | Low |
| **Public transport info** | Reduce friction for visitors | Low |
| **Holiday schedule** | Avoid confusion | Low |
| **Sunday policy** | Clarify if open/closed | Medium |

---

## C. Image Alt Text Guidelines

When real photos replace placeholders:

- **Hero image:** "Interior del estudio TEMPLO en Cochabamba — espacio de entrenamiento con iluminación tenue y equipamiento"
- **Coach photos:** "[Nombre] — coach en TEMPLO" (e.g., "Lucas Bustamante — fundador y coach en TEMPLO")
- **Service photos:** Descriptive of what's shown (e.g., "Sesión de Power Plate en TEMPLO" — not generic)
- **Activity reel:** Specific to what's shown (e.g., "Entrenamiento de calistenia en TEMPLO")
- **Decorative images:** Use `alt=""` with `aria-hidden="true"`

**Do NOT:** Use alt text that claims the image shows TEMPLO if it's a stock photo.
